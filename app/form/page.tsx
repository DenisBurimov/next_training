            ...
            <div className="flex justify-center">
                <form className='p-5 border border-black' onSubmit={handleSubmit}>
                    <div className="flex flex-col">
                        ...
                        <input type="email" id="email" name="email" className='border border-black' value={formData.email} onChange={handleChange} />

                        <label htmlFor="password">Password</label>
                        <input type="password" id="password" name="password" className='border border-black' value={formData.password} onChange={handleChange} />
